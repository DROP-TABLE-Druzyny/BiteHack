...
export default function Page() {
  ...
  return (
    ...
    >
      <div className={`w-full flex flex-col items-center justify-center transition-all duration-500 ease-in-out ${
        showResults ? 'mt-8' : 'mt-[25%]'
      }`}>
        <div className='flex items-center justify-center'>

        <a href="/" className="p-2 mb-8 mr-4 bg-amber-600 border-1 border-white rounded-full shadow-lg text-3xl text-white drop-shadow-md font-bold">
